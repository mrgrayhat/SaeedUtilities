...
namespace Saeed.Utilities.Infrastructures.Mongo.Repositories
{
    ...
    public interface IMongoRepositoryManager<T, TKey>
        where T : IBaseEntity<TKey>
    {
        ...
        long GetTotalDatabaseStorageSize();
        ...
        DatabaseStatsResult GetDatabaseStats();
        /// <summary>
    ...
    public interface IRepositoryManager<T> : IMongoRepositoryManager<T, string>
