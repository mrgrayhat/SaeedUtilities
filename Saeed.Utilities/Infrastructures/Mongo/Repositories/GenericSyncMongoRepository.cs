...
namespace Saeed.Utilities.Infrastructures.Mongo.Repositories
{
    ...
    public class GenericSyncMongoRepository<T, TKey> : IGenericSyncMongoRepository<T, TKey> where T : IBaseEntity<TKey>
    {
        /// <summary>
        ...
        public GenericSyncMongoRepository()
        ...
        public GenericSyncMongoRepository(string connectionString)
        {
            collection = MongoUtils<TKey>.GetCollectionFromConnectionString<T>(connectionString);
        }
        ...
        public GenericSyncMongoRepository(string connectionString, string collectionName)
        {
            collection = MongoUtils<TKey>.GetCollectionFromConnectionString<T>(connectionString, collectionName);
        }
        ...
        public GenericSyncMongoRepository(MongoUrl url)
        {
            collection = MongoUtils<TKey>.GetCollectionFromUrl<T>(url);
        }
        ...
        /// <param name="url">Url to use for connecting to MongoDB.</param>
        /// <param name="collectionName">The name of the collection to use.</param>
        public GenericSyncMongoRepository(MongoUrl url, string collectionName)
        {
            collection = MongoUtils<TKey>.GetCollectionFromUrl<T>(url, collectionName);
        }
        ...
        {
            if (typeof(T).IsSubclassOf(typeof(BaseEntity)) || typeof(T).IsSubclassOf(typeof(AuditableBaseEntity<TKey>)))
            {
        ...
        {
            if (typeof(T).IsSubclassOf(typeof(BaseEntity)) || typeof(T).IsSubclassOf(typeof(IBaseEntity)))
            {
    ...
    public class GenericSyncMongoRepository<TEntity> : GenericSyncMongoRepository<TEntity, string>, IGenericSyncMongoRepository<TEntity>
