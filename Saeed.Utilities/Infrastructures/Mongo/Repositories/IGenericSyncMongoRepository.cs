...
namespace Saeed.Utilities.Infrastructures.Mongo.Repositories
{
    ...
    public interface IGenericSyncMongoRepository<T, TKey> : IQueryable<T>
    ...
    public interface IGenericSyncMongoRepository<T> : IQueryable<T>, IGenericSyncMongoRepository<T, string>
